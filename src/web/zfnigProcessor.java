...
/**
 * 尼日利亚广东经贸合作区 page processor
 * 
 */
public class zfnigProcessor implements PageProcessor {
	...
	public zfnigProcessor(String domain, String charset, int taskId, String name, String source) {
		super();
		this.domain = domain;
		this.taskId = taskId;
		this.name = name;
...
//				String url = "http://www.zfnig.com/cn/" + temp;
...
//						System.exit(0);
			...
			List<String> linkurls = html.xpath("//div[@class='main']//table//td[@align='right']/a[@disabled!='true']").replace("(?is)<.*?>", "").all();
//			for(String a:linkurls)
...
//				System.out.println(tmp);
				...
				String a = tmp.substring(tmp.indexOf("=")+1);
				int num = Integer.valueOf(a);
				num++;
				String b = tmp.substring(0,tmp.indexOf("=")+1);
				newurl = b+num;
